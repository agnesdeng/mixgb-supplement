...
n1e3p10 <- summary(A)
n1e3p10
saveRDS(n1e3p10, file = "result/categorical/n1e3p10.rds")
...
n1e3p30 <- summary(B)
n1e3p30
saveRDS(n1e3p30, file = "result/categorical/n1e3p30.rds")
...
n1e3p50 <- summary(C)
n1e3p50
saveRDS(n1e3p50, file = "result/categorical/n1e3p50.rds")
