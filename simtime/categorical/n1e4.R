...
n1e4p10 <- summary(A)
n1e4p10
saveRDS(n1e4p10, file = "result/categorical/n1e4p10.rds")
...
n1e4p30 <- summary(B)
n1e4p30
saveRDS(n1e4p30, file = "result/categorical/n1e4p30.rds")
...
n1e4p50 <- summary(C)
n1e4p50
saveRDS(n1e4p50, file = "result/categorical/n1e4p50.rds")
