...
n1e3p10 <- readRDS(file = "result/continuous/n1e3p10.rds")
n1e3p30 <- readRDS(file = "result/continuous/n1e3p30.rds")
n1e3p50 <- readRDS(file = "result/continuous/n1e3p50.rds")

n1e4p10 <- readRDS(file = "result/continuous/n1e4p10.rds")
n1e4p30 <- readRDS(file = "result/continuous/n1e4p30.rds")
n1e4p50 <- readRDS(file = "result/continuous/n1e4p50.rds")

n1e5p10 <- readRDS(file = "result/continuous/n1e5p10.rds")
n1e5p30 <- readRDS(file = "result/continuous/n1e5p30.rds")
n1e5p50 <- readRDS(file = "result/continuous/n1e5p50.rds")

n1e6p10 <- readRDS(file = "result/continuous/n1e6p10.rds")
n1e6p30 <- readRDS(file = "result/continuous/n1e6p30.rds")
n1e6p50 <- readRDS(file = "result/continuous/n1e6p50.rds")
