...
n1e5p10 <- summary(A)
n1e5p10
saveRDS(n1e5p10, file = "result/continuous/n1e5p10.rds")
...
n1e5p30 <- summary(B)
n1e5p30
saveRDS(n1e5p30, file = "result/continuous/n1e5p30.rds")
...
n1e5p50 <- summary(C)
n1e5p50
saveRDS(n1e5p50, file = "result/continuous/n1e5p50.rds")
