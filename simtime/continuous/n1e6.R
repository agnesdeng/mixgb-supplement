...
n1e6p10 <- summary(A)
n1e6p10
saveRDS(n1e6p10, file = "result/continuous/n1e6p10.rds")
...
n1e6p30 <- summary(B)
n1e6p30
saveRDS(n1e6p30, file = "result/continuous/n1e6p30.rds")
...
n1e6p50 <- summary(C)
n1e6p50
saveRDS(n1e6p50, file = "result/continuous/n1e6p50.rds")
