...
mixgb_boot.maxit1 <- readRDS(file = "result/mixgb_boot/runs1000.rds")
...
all.output <- list(
  ...
  "mixgb_boot.maxit1" = mixgb_boot.maxit1
)
...
Methods <- c("mice.default", "mice.cart", "mice.rf", "mixgb", "mixgb.boot")
...
# save figures
dir.path <- "C:/Users/agnes/Desktop/mixgb-paper/jcgs/figures"
